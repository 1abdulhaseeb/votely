    ...
    <div class="login-container">
      <div class="login-card">
        <div class="login-header">
          ...
          <h2>Welcome Back</h2>
          <p>Sign in to your Votely account</p>
        </div>
...
.login-page::before {
  ...
  right: 0;
  bottom: 0;
  background: radial-gradient(circle at 30% 20%, rgba(30, 49, 133, 0.05) 0%, transparent 50%),
              radial-gradient(circle at 70% 80%, rgba(30, 49, 133, 0.05) 0%, transparent 50%);
  pointer-events: none;
}
